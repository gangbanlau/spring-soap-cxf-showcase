...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements com.maingel.soap.web.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:8080/soap/helloWorld";
    ...
    public com.maingel.soap.web.IHelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.maingel.soap.web.HelloWorldImplServiceSoapBindingStub _stub = new com.maingel.soap.web.HelloWorldImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.maingel.soap.web.IHelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.maingel.soap.web.HelloWorldImplServiceSoapBindingStub _stub = new com.maingel.soap.web.HelloWorldImplServiceSoapBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.soap.maingel.com/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.soap.maingel.com/", "HelloWorldImplPort"));
        }
